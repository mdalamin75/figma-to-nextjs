            ...
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-extrabold text-gray-900 sm:text-5xl">
                        De ce să alegi <span className="text-transparent bg-clip-text bg-gradient-to-b from-blue-500 to-gray-900 to-95%">@Byte</span>
                    </h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {currentPlans.map((plan, index) => (
                        <div key={index} className={`rounded-2xl p-8 transition-all duration-300 ease-in-out text-center bg-white border-2 border-blue-200 ${plan.recommended ? 'border-2 border-blue-500 shadow-2xl transform scale-105' : 'bg-gray-50 shadow-lg'}`}>
                            {plan.recommended && (
